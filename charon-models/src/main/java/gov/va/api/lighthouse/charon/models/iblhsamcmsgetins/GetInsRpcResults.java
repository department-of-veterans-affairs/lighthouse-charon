...
/**
 * Response model for the IBLHS AMCMS GET INS RPC. Generated using insuranceElementList.xlsx version
 * 183.0.
 */
@Data
@Builder
...
public class GetInsRpcResults {
  ...
  /** 30 "Coverage.beneficiary.birthDate \nCoverage.subscriber.birthDate". */
  ...
  /** 34 "Coverage.beneficiary.identifier \nCoverage.subscriber.identifier". */
  private GetInsEntry insTypeInsuredsSsn;
  /** 35 "Coverage.beneficiary.address.line \nCoverage.subscriber.address.line". */
  private GetInsEntry insTypeInsuredsStreet1;
  /** 36 "Coverage.beneficiary.address.line \nCoverage.subscriber.address.line". */
  private GetInsEntry insTypeInsuredsStreet2;
  /** 37 "Coverage.beneficiary.address.city \nCoverage.subscriber.address.city". */
  private GetInsEntry insTypeInsuredsCity;
  /** 38 "Coverage.beneficiary.address.state \nCoverage.subscriber.address.state". */
  private GetInsEntry insTypeInsuredsState;
  /** 39 "Coverage.beneficiary.address.postalCode \nCoverage.subscriber.address.postalCode". */
  private GetInsEntry insTypeInsuredsZip;
  /**
   * 40 "Coverage.beneficiary.telecom.value \nCoverage.subscriber.telecom.value \nsystem = phone".
   */
  private GetInsEntry insTypeInsuredsPhone;
  /** 41 "Coverage.beneficiary.gender \nCoverage.subscriber.gender". */
  private GetInsEntry insTypeInsuredsSex;
  /** 42 "Coverage.beneficiary.address.country \nCoverage.subscriber.address.country". */
  private GetInsEntry insTypeInsuredsCountry;
  /** 43 "Coverage.beneficiary.address.state \nCoverage.subscriber.address.state". */
  ...
  /**
   * 50 "Coverage.beneficiary.identifier.value \nCoverage.beneficiary.identifier.type.coding.code=MB
   * \n".
   */
  ...
  /**
   * 52 "Coverage.beneficiary.identifier.value \nCoverage.subscriber.identifier.value
  ...
  /**
   * 54 "Coverage.beneficiary.identifier.value \nCoverage.subscriber.identifier.value
  ...
  /**
   * 56 "Coverage.beneficiary.identifier.value \nCoverage.subscriber.identifier.value
  ...
  /**
   * 58 "Coverage.beneficiary.identifier.value \nCoverage.beneficiary.identifier.system =
  ...
  /**
   * 60 "Coverage.beneficiary.identifier.value \nCoverage.beneficiary.identifier.system =
  ...
  /**
   * 62 "Coverage.beneficiary.identifier.value \nCoverage.beneficiary.identifier.system =
  ...
  /**
   * 70 "insurance.item.category \ninsurance.item.category.coding.system =
  ...
  /**
   * 146 "Organization.contact.extension.display \nOrganization.contact.extension.url =
   * via-intermediary".
   */
  ...
  /**
   * 155 "Organization.contact.extension.display \nOrganization.contact.extension.url =
   * via-intermediary".
   */
  ...
  /**
   * 185 "Organization.contact.extension.display \nOrganization.contact.extension.url =
   * via-intermediary".
   */
  private GetInsEntry insCoInquiryCompanyName;
  /** 186 Organization.extension. */
  private GetInsEntry insCoAnotherCoProcessInquiries;
  /** 187 "Organization.contact.telecom.value \nOrganization.contact.telecom.system=fax". */
  private GetInsEntry insCoInquiryFax;
  /** 189 "Organization.contact.address.line \nOrganization.contact.purpose = OUTPTCLAIMS". */
  ...
  /**
   * 218 "Organization.contact.extension.display \nOrganization.contact.extension.url =
   * via-intermediary".
   */
  ...
  /** 220 "Organization.contact.telecom.value \nOrganization.contact.telecom.system = fax". */
  ...
  /** 224 "Organization.identifier \nidentifier.type.coding.code=PROFEDI". */
  private GetInsEntry insCoEdiIdNumberProf;
  /** 225 . */
  private GetInsEntry insCoBinNumber;
  /** 226 "Organization.identifier \nidentifier.type.coding.code=INSTEDI". */
  ...
  /**
   * 250 "Organization.identifier.type.coding.code \nOrganization.identifier.type.coding.system =
  ...
  /**
   * 252 "Organization.identifier.type.coding.code \nOrganization.identifier.type.coding.system =
  ...
  /**
   * 254 "Organization.identifier.type.coding.code \nOrganization.identifier.type.coding.system =
  ...
  /**
   * 256 "Organization.identifier.type.coding.code \nOrganization.identifier.type.coding.system =
  ...
  /** 270 "Organization.identifier.value \nOrganization.identifier.type.coding.code = 277EDI \n". */
  ...
  /**
   * 280 "InsurancePlan.plan.type.coding.code \nInsurancePlan.plan.type.coding.system =
  ...
  /**
   * 285 "InsurancePlan.type.coding.code \nInsurancePlan.type.coding.system =
   * 2.16.840.1.113883.3.8901.3.355803.8014".
   */
  private GetInsEntry groupPlanPlanCategory;
  /**
   * 286 "InsurancePlan.type.coding.code \nInsurancePlan.type.coding.system =
  ...
  /** 311 "insurance.item.description \ninsurance.item.excluded = true". */
